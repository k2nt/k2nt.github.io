...
export const ABOUT: string[] = [
  ...
  "I am an avid reader. When not reading technical papers, I tend toward history and philosophy. I am an Arsenal fan, have two dogs I love dearly, and like to run. I am currently working on learning French, picking up skateboarding, and running a full marathon.",
